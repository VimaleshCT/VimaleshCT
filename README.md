...
![Profile Views](https://komarev.com/ghpvc/?username=VimaleshCT&color=00D9FF&style=for-the-badge&label=PROFILE+VIEWS)
...
class Vimalesh:
    def __init__(self):
        ...
        self.tools       = ["Git", "Postman", "Figma", "Power BI", "Tableau", "Pandas"]
        self.goal        = "Ship products that make a real-world difference 🌍"
...
- 👥 Led a **5-member team** to build **Techofes Portal** → served **1,500+ users** with live event updates, improved communication turnaround **40%**
...
<!--
  TROPHY STRATEGY: Three mirror URLs are tried in order.
  If the first breaks, manually swap to the next one.
  Mirror 1 (primary):   https://github-profile-trophy.vercel.app
  Mirror 2 (backup):    https://github-trophies.vercel.app         ← shows ALL secret trophies too
  Mirror 3 (backup):    https://github-profile-trophy.screw-hand.vercel.app

  PERMANENT FIX: Fork https://github.com/ryo-ma/github-profile-trophy
  and deploy it on your own Vercel account → use your own URL below.
-->

<div align="center">

<img src="https://github-trophies.vercel.app/?username=VimaleshCT&theme=tokyonight&no-frame=true&margin-w=12&margin-h=12&no-bg=true" />
